...
def get_args():
    ...
    parser.add_argument('--total_steps', default=300, type=int, help='number of gradient steps')
...
if __name__ == "__main__":
    ...
    path = '{}/{}{}-{}-{}p.tar'.format(args.save_dir, 'jackal',label, args.solver, args.num_points)
    torch.save(model.state_dict(), path)
    path = '{}/{}{}-{}-{}p-stats.pkl'.format(args.save_dir, 'jackal', label, args.solver, args.num_points)
    print("Saved file: ", path)
    to_pickle(stats, path)
